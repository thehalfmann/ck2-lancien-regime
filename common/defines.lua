NDefines = {
	...
	NDiplomacy = {
		...
		DEMESNE_MAX_SIZE_DUKE_MULT = 5.0,			-- Extra Max Demesne Size from the ruler's rank
		DEMESNE_MAX_SIZE_KING_MULT = 30.0,			-- Extra Max Demesne Size from the ruler's rank
		DEMESNE_MAX_SIZE_EMPEROR_MULT = 50.0,		-- Extra Max Demesne Size from the ruler's rank
		...
		MAX_DUCHIES_LEGALLY_HELD = 5,								-- Max duchies that a king or above can hold before vassals start getting angry
	...
	NMilitary = {
		...
		ARCHERS_PHASE_SKIRMISH_ATTACK = 1,
		ARCHERS_PHASE_MELEE_ATTACK = 1,
		ARCHERS_PHASE_PURSUE_ATTACK = 10,
	...
	NAI =
	{
		...
		DOW_AGGRESSION_FACTOR = 0.10,							-- General aggressiveness declarations of war
		MARRIAGE_AI_PRESTIGE_VALUE = 0.40,						-- Multiplier for how highly AI values prestige when arranging marriages and evaluating marriage offers
		...
		RAID_AGGRESSION = 25,									-- General frequency of raids. A LOWER number means more often!
